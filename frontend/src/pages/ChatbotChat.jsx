...
const Chat = () => {
    ...
    useLayoutEffect(() => {
        ...
        // Do not auto-scroll on the very first static agent message
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-accent/70">
                                        {getAgentSpecialty(agentInfo?.id)}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        {messages.map((msg, index) => (
                            ...
                            >
                                ...
                                <div
                                    className={`max-w-md md:max-w-lg px-4 py-2 md:py-3 rounded-2xl shadow-md ${
                                        msg.sender === 'user'
                    ...
                    <div className="p-4 border-t border-primary/20 bg-surface/30">
                        <form onSubmit={handleSubmit} className="flex gap-3">
                            <input
                                ...
                                className="flex-1 bg-background text-accent border-2 border-primary/30 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50"
                                disabled={isLoading}
                            />
                            <button
                                type="submit"
